...
- My name: Kevin Berbel
- My title: Fundador — Riqueza Digital
- My company: Riqueza Digital (riquezadigital.es)
- Value prop: Ayudamos a pymes y agencias a crecer con marketing digital, automatización e IA aplicada

## Signature
Kevin Berbel — Riqueza Digital
info@riquezadigital.es

## Proof Points
- [Completar con caso real aprobado por Kevin — sectores trabajados: alimentación healthy (Veganashi), reparación electrodomésticos (Tecniclima), headhunting internacional (Anywr), legal boutique (Keller)]
- Nunca inventar métricas: si no hay caso verificado, usar prueba social de sector, no de resultados

## CTA Options
- Default: "¿Te encaja una llamada de 15 min?"
- Softer: "¿Te interesa que te cuente cómo lo haríamos?"
- Specific: "¿Te mando un mini-análisis de tu caso?"

## Tone
- Cercano + técnico accesible (referencias: Euge Oller, Enrique Rocha)
- Antirreferencia: gurú motivacional, marketing-speak, frases huecas
```
...
## Contexto RD (Riqueza Digital)

- **Idioma**: español por defecto; inglés solo para prospectos internacionales
- **Cold email B2B en España**: cumplir LSSI + RGPD — identificación clara del remitente, opción de baja, y solo contactos B2B con interés legítimo justificable. Nunca cargar listas en secuencias automatizadas sin verificar consentimiento (ver skill `email-marketing`)
- **Nunca enviar directamente**: esta skill entrega borradores; el envío lo hace Kevin tras revisarlos
- **Guardado**: borradores de outreach en `output/agency/YYYY-MM-DD_outreach-<empresa>.md`
