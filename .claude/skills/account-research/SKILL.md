...
- **Sin CRM externo**: el CRM de RD es Notion — busca primero si el prospecto ya existe en Notion antes de investigar desde cero
- **Guardado**: dossiers de prospección en `output/agency/YYYY-MM-DD_prospect-<empresa>.md`; si el prospecto se convierte en cliente, ejecutar `/clientes:nuevo-cliente` y mover lo relevante a su `profile.md`
- **ICP de referencia**: pymes y agencias españolas — ver `agencia/marketing/strategy/brief-estrategico.md` antes de calificar
- **Competidores de RD**: para investigar competidores de Agencia Agéntica usa el sistema de inteligencia competitiva (`agencia/inteligencia-competitiva/`), no esta skill
