...
- **Conectores reales**: Google Calendar MCP para localizar la reunión; Notion (CRM de RD) para el historial del prospecto/cliente; Gmail MCP si está autenticado
- **Guardado**: brief de la llamada en `output/agency/YYYY-MM-DD_call-prep-<empresa>.md`
- **Idioma**: prep en español salvo reunión internacional
- **Tras la llamada**: crear las tareas de seguimiento en Notion (estado "Por hacer", asignadas a Kevin)
