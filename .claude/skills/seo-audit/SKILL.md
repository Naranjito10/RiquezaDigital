...
- **Datos reales primero**: usa el Ahrefs MCP (Site Explorer, Keywords Explorer, Site Audit, Rank Tracker) en lugar de estimaciones siempre que el dominio esté accesible
- **Guardado (regla 4 del orquestador)**: `clients/<nombre>/reports/YYYY-MM-DD_seo-audit.md`
- **Complementa** a `/marketing:auditar-cuenta`, que cubre cuentas de ads (Meta/Google) pero no SEO
- **Siguientes pasos**: los briefs de contenido derivados se generan con el skill `seo-content`; para el blog propio de RD usar `/contenido:boveda-post`
- **SEO en español**: investigar keywords en el idioma objetivo — los volúmenes y dinámicas difieren del inglés
